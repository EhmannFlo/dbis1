...
public class DBISUtils {
    ...
    private static final String DB_LOGIN =    "dbs21_b";
    private static final String DB_PASSWORD = "dbs21_b";


    // Connection parameters to be used for connecting to the DBIS@HTWG Oracle 12c DBS instance are:
    // + jdbc:oracle:thin:             -> identifier for the thin Oracle JDBC driver
    // + oracle12c.in.htwg-konstanz.de -> host running the Oracle DBS instance
    // + 1521                          -> port used by the Oracle DBS instance for JDBC connections
    // + ora12c                        -> identifier of the Oracle DBS instance to be connected with

    // Oracle JDBC-URL pattern is:
    // <Oracle-JDBC-Driver-identifier>@<host>:<port>:<instance-identifier>,
    // e.g.,         jdbc:oracle:thin:@<host>:<port>:<instance-identifier>
